    ...
    <div className="lg:col-span-3">
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-6 dark:text-white">
          {user
            ? LANGUAGE.DASHBOARD.PURCHASED[user.preferences.language]
            : LANGUAGE.DASHBOARD.PURCHASED.en}
        </h2>
        {purchased.length == 0 ? (
          <p className="text-xl flex dark:text-gray-200 justify-center">
            {user
              ? LANGUAGE.DASHBOARD.ANYITEMS[user.preferences.language]
              : LANGUAGE.DASHBOARD.ANYITEMS.en}
          </p>
        ) : (
